    ...
    (t.prototype.onTouchEnd = function(t) {
      ...
      if (
        ...
        r &&
          ...
          (l =
            document.elementFromPoint(u.pageX - window.pageXOffset, u.pageY - window.pageYOffset) ||
            l),
        ...
        return t.timeStamp - a > 100 || (o && window.top !== window && 'input' === c)
          ? ((this.targetElement = null), !1)
          : (this.focus(l),
            this.sendClick(l, t),
            (o && 'select' === c) || ((this.targetElement = null), t.preventDefault()),
            !1);
      return o &&
        !i &&
        ((s = l.fastClickScrollParent), s && s.fastClickLastScrollTop !== s.scrollTop)
        ? !0
      ...
      return 'none' === t.style.msTouchAction || 'manipulation' === t.style.touchAction
        ...
        : ((r = +(/Firefox\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1]),
          ...
          e &&
            ...
            ? !0
            : 'none' === t.style.touchAction || 'manipulation' === t.style.touchAction
            ? !0
            : !1);
    }),
