...
@observer
class Privacy extends React.Component<PropsType, null> {
    ...
    return (
      <div className="privacy">
        ...
        <p>
          ...
          document contains types of information that is collected and recorded by The Emoji Match
          and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in The Emoji
        ...
        <h2>Log Files</h2>
        <p>
          The Emoji Match follows a standard procedure of using log files. These files log visitors
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on The
          Emoji Match, which are sent directly to users&apos; browser. They automatically receive
        ...
        <p>
          Note that The Emoji Match has no access to or control over these cookies that are used by
          third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          The Emoji Match&apos;s Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
          The Emoji Match does not knowingly collect any Personal Identifiable Information from
