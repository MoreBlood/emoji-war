...
export const inGameStoreItems = [
  new StoreItem({ name: 'Tarantino dream', id: 'TARANTINO_GAME_MODE', icon: '🦶', price: 15 }),
  ...
  new StoreItem({ name: 'Pew pew', id: 'PEW_GAME_MODE', icon: '👊', price: 15 }),
  new StoreItem({ name: 'Extra life', id: 'EXTRA_LIFE', icon: '❤️', price: 50 }),
  new StoreItem({
    name: 'Slow down',
    id: 'SLOW_DOWN',
    icon: '🕐',
